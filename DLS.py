...
def build_tree():
    ...
    return root
def dls(root, start, goal, depth_limit, current_depth=0):
...
def main():
    ...
    print("Starting Depth-Limited Search (DLS) traversal from node", start_node)
    print("Goal node is", goal_node)
    print("Depth Limit is", depth_limit)
    print("------------------------------")
    final_path = dls(root, start_node, goal_node, depth_limit)
    print("------------------------------")
