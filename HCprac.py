...
print(f"Optimal Solution (y=sin(x)): x = ", optimal_x1, ",y= ", optimal_y1)
optimal_x2, optimal_y2 = hill_climbing(quadratic_function)
print(f"Optimal Solution (y=-x^2): x = ", optimal_x2, ",y= ", optimal_y2)
optimal_x3, optimal_y3 = hill_climbing(quadratic_function2)
print(f"Optimal Solution (y=-5x^2+3x+6): x = ", optimal_x3, ",y= ", optimal_y3)